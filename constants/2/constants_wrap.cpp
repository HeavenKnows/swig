...
#define SWIG_name      "constants"
#define SWIG_init      luaopen_constants
#define SWIG_init_user luaopen_constants_user

#define SWIG_LUACODE   luaopen_constants_luacode
...
extern "C" {
#endif
static int _wrap_c_double_get(lua_State* L) {
  int SWIG_arg = 0;
  double result;
  
  SWIG_check_num_args("c_double",0,0)
  result = (double)(double)c_double;
...
static swig_lua_const_info swig_SwigModule_constants[]= {
    ...
    {SWIG_LUA_CONSTTAB_FLOAT("BLAH", 24.10)},
    {0,0,0,0,0,0}
};
